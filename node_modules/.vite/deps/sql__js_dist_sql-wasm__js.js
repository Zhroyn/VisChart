  ...
  "node_modules/sql.js/dist/sql-wasm.js"(exports, module) {
    ...
    var initSqlJs = function(moduleConfig) {
      ...
      initSqlJsPromise = new Promise(function(resolveModule, reject) {
        ...
        if (Aa)
          D = za ? require_path().dirname(D) + "/" : __dirname + "/", Fa = () => {
            Ea || (fs = require_fs(), Ea = require_path());
          }, Ba = function(a, b) {
            Fa();
            a = Ea.normalize(a);
          ...
          }, 1 < process.argv.length && (wa = process.argv[1].replace(/\\/g, "/")), process.argv.slice(2), "undefined" != typeof module && (module.exports = e), e.inspect = function() {
...
//# sourceMappingURL=sql__js_dist_sql-wasm__js.js.map
